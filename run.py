...
def pgText(text, pos, font_size, font_name=GAME_FONT):
            ...
            if game_over:
                ...
                if len(game.pos[2].discs) == game.n_discs:
                    if moves_counter == game.min_moves:
                        pgText(game_dict[lang]['congrats_min'], (GAME_WIDTH/2, GAME_HEIGHT/3), 20)
                    else:
                        pgText(game_dict[lang]['congrats_aja'], (GAME_WIDTH/2, GAME_HEIGHT/3), 20)
